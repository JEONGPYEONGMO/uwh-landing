  ...
  const tournaments = [
    {
      ...
      organizer: 'CMAS Asia',
      participants: 145,
      description: '아시아 최대 규모의 수중하키 대회',
      website: 'https://cmasasia.org/championship2025',
      image: '🏆'
    },
    {
      id: 2,
      title: '2025 China National UWH Championship',
      date: '2025-11-20',
      endDate: '2025-11-25',
      location: 'Beijing',
      type: 'tournament',
      organizer: 'China UWH Federation',
      participants: 89,
      description: 'Annual national championship',
      website: 'https://chinauwh.cn/championship',
      image: '🇨🇳'
    }
  ];
              ...
              <div className="md:flex">
                ...
                <div className="bg-gradient-to-r from-red-500 to-orange-500 p-8 text-white md:w-2/5">
                  ...
                  <div className="space-y-3 mt-6">
                    ...
                    <div className="flex items-center gap-2">
                      <Users className="w-5 h-5" />
                      <span>{event.participants}명 참가 예정</span>
                    </div>
                  </div>
                </div>
